    ...
    <div className=" px-14 py-4">
      <div className="flex justify-between gap-4 text-gray-500">
        <div className="flex flex-col gap-4">
          <p className="text-2xl text-gray-500 font-semibold">Company</p>
        ...
        <div className="flex flex-col gap-4">
          <p  className="text-2xl text-gray-500 font-semibold">Community</p>
        ...
        <div className="flex flex-col gap-4">
          <p  className="text-2xl text-gray-500 font-semibold"> Licensing</p>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex">
            <p  className="text-2xl text-gray-500 font-semibold"> Social</p>
          </div>
        ...
        <div className="flex flex-col items-start ">
          <p  className="text-2xl text-gray-500 font-semibold">Download the app</p>
      ...
      <div className="flex justify-between text-gray-500 py-4">
        <p  className="text-xl text-gray-500 font-semibold">© 500px</p>
